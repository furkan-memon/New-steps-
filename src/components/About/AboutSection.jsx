...
export default function AboutSection() {
          ...
          <div className="flex-1">
            ...
            <div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-[15px] leading-relaxed">
                  To become a trusted kids footwear brand known for comfort,
                  safety, and modern design. We aim to make every step joyful
                  and confident for children across India.
                </p>
              </div>
  ...
  <div className="flex gap-4">
    ...
    <div className="w-1/2 h-[240px] overflow-hidden rounded-2xl">
      <img
    ...
    <div className="w-1/2 h-[240px] object-bottom overflow-hidden rounded-2xl">
      <img
