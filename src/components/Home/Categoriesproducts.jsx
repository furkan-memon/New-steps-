...
const CategoriesProduct = () => {
  ...
  return (
    <section className="py-12 container mx-auto lg:px-6">
      <div className="mb-10">
      ...
      <div className="flex overflow-x-auto gap-3 mb-10">
        {categories.map((cat) => (
          <button
            ...
            className={`px-6 py-2.5 mb-2 whitespace-nowrap rounded-full text-sm font-medium border shadow-sm transition
            ${
              activeTab === cat
      ...
      <div className="relative ">
        ...
        >
         ...
         <ProductCard products={filteredProducts.slice(0, 8)} showButton={true} />
          ) : (
